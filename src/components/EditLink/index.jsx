...
const CardBlock = ({ data }) => {
  ...
  return (
    <React.Fragment>
      <CardContent>
        <Grid container>
          ...
          <Grid xs={11} pl={1}>
            <ClickAwayListener
              onClickAway={() =>
                isEditing == "title" ? setIsEditing("") : null
              }
            >
              <Box style={{ display: "flex" }}>
                <TextField
                  ...
                  disabled={isEditing == "title" ? false : true}
                />
                {isEditing == "title" ? (
                  <CheckRounded
                    fontSize="small"
            ...
            <ClickAwayListener
              onClickAway={() =>
                isEditing == "link" ? setIsEditing("") : null
              }
            >
              <Box style={{ display: "flex" }}>
                <TextField
                  ...
                  disabled={isEditing == "link" ? false : true}
                />
                {isEditing == "link" ? (
                  <CheckRounded
                    fontSize="small"
        ...
        <Grid container spacing={3} xs={{ flexGrow: 1 }} pb={1}>
          ...
          <Grid xs={9}>
            <IconButton
              ...
              onClick={() => actionItemHandler("schedule")}
            >
              <Schedule />
            </IconButton>
            <IconButton
              aria-label="toggle password visibility"
              onClick={() => actionItemHandler("geo-location")}
            >
              <Terrain />
            </IconButton>
            <IconButton aria-label="toggle password visibility">
      ...
      <div
        style={{
          height: isOpenEditView ? "200px" : "0px",
      ...
      >
        <Grid container spacing={3} xs={{ flexGrow: 1 }}>
          ...
          <Grid
            xs={9}
            style={{
              display: isOpenEditView ? "block" : "none",
              transition: "all 0.1s linear",
            }}
          >
            <div
              style={{ display: editViewType == "schedule" ? "block" : "none" }}
            >
